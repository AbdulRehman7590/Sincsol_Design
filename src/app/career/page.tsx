...
export default function CareerPage() {
  ...
  return (
    <>
      ...
      <section className="min-h-[75vh] relative container mx-auto mt-12 px-16 py-16">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative sm:ml-[15%] aspect-square md:aspect-auto md:h-[500px] rounded-lg overflow-hidden"
          >
            <Image
      ...
      {/* Decorative dots */}
      <div className="flex justify-end mr-8 transform translate-y-[-60%] animate-float">
        <Image
          ...
          <div className="grid md:grid-cols-[350px,1fr] gap-12">
            ...
            <div className="relative">
              <Image
                ...
                width={128}
                height={128}
                className="object-cover mr-32 mb-8 hidden sm:block animate-rotate"
              />
