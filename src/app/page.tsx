...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const onSelect = () => {
      ...
      setActiveIndex(
        selectedIndex >= totalSlides ? middleIndex : selectedIndex
      );
    };
  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-gradient-to-t from-[#f4e4c4]/80 to-[#f6e2e5]">
        ...
        <div className="animate-zoom-in container pt-48 pb-20 px-12 grid lg:grid-cols-2 gap-20 items-center">
      ...
      <section className="py-20 lg:pb-20">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }} // Runs once when 20% is visible
          ...
          >
            ...
            <div className="text-center mb-16">
              ...
              <p className="max-w-2xl mx-auto text-gray-600">
                ...
                and drive growth. Our expert team creates tailored applications
                ...
                <Card className="p-6 bg-white shadow-lg rounded-xl">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600">
                      Powered by advanced tools like ChatGPT and CoPilot,
                      software development is now faster and more efficient than
                      ever. Our engineers, skilled in these cutting-edge
                      technologies, are dedicated to maximizing the ROI of your
                      project.
                    </p>
                    <p className="text-gray-600">
                      Experience our expertise risk-free for the first 2 weeks.
                      We&apos;re confident in the value we bring—if we
                      don&apos;t make a positive impact, we&apos;ll keep working
                      at no cost until we do.
                    </p>
                  </div>
                </Card>
              </motion.div>
              {/* Bottom Card - Fade in Left */}
              <motion.div
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
