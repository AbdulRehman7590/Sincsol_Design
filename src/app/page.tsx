...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const onSelect = () => {
            ...
            setActiveIndex(selectedIndex >= totalSlides ? middleIndex : selectedIndex);
        };
                ...
                <div className="animate-zoom-in container pt-48 pb-20 px-12 grid lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-8 max-w-xl">
                        <h1 className="text-5xl font-bold leading-tight">
                            ...
                            Software that{" "}
                            <div
                                className="px-6 py-2 text-4xl font-bold border-4 border-[#8B5CF6] rounded-lg text-transparent inline-block bg-clip-text bg-gradient-to-b from-pink-500 to-yellow-400">
                                Delivers!
                            </div>
                        </h1>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mx-auto">
                            {features.map((feature, index) => (
                                ...
                                >
                                    <div
                                        className="absolute inset-0 h-24 bg-gradient-to-b from-[#b69ff4] to-[#fabda9] rounded-b-full"/>
                                    <div className="relative z-10">
                                        {/* Number and Title */}
                                        <div className="flex items-center justify-center gap-2 mb-2">
                                            <div
                                                className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 font-bold text-lg">
                                                {index + 1}
                                            </div>
